...
// WARNING - Only literal values are allowed in lifecycle meta-argument, as it affects the graph construction, see https://www.terraform.io/docs/language/meta-arguments/lifecycle.html
